...
(function () {
  ...
  function InlineCreate(props) {
    ...
    const submit = function () {
      ...
      // Per-task model override (blank = inherit the assignee profile default).
    ...
    return h("div", { className: "hermes-kanban-inline-create" },
      ...
      h(Input, {
        ...
        placeholder: tx(t, "modelPlaceholder",
          "model (optional): e.g. anthropic/claude-sonnet-4 — overrides the profile default"),
        title: "Per-task model slug; passed to the worker as -m <model>, overriding the assignee profile's default model.",
        className: "h-7 text-xs",
      }),
